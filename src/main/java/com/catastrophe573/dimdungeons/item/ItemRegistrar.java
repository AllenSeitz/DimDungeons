...
public class ItemRegistrar
{
    ...
    public static final RegistryObject<Item> ITEM_GILDED_PORTAL = ItemRegistrar.ITEMS.register(BlockGildedPortal.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_GILDED_PORTAL.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
    ...
    public static final RegistryObject<Item> ITEM_PORTAL_KEYHOLE = ItemRegistrar.ITEMS.register(BlockPortalKeyhole.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_KEYHOLE.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
    public static final RegistryObject<Item> ITEM_PORTAL_CROWN = ItemRegistrar.ITEMS.register(BlockPortalCrown.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_CROWN.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
    public static final RegistryObject<Item> ITEM_CHARGER_FULL = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_FULL, () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_FULL.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
