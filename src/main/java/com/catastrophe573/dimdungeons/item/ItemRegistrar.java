...
public class ItemRegistrar
{
	...
	public static final CreativeModeTab CREATIVE_TAB = new CreativeModeTab(DimDungeons.MOD_ID)
	{
		...
		{
			return new ItemStack(ITEM_PORTAL_KEY.get());
		}
	};
	...
	public static final RegistryObject<Item> ITEM_SECRET_BELL = ITEMS.register(ItemSecretBell.REG_NAME,
	        () -> new ItemSecretBell(new Item.Properties().tab(CREATIVE_TAB).stacksTo(1)));
	public static final RegistryObject<Item> ITEM_HOMEWARD_PEARL = ITEMS.register(ItemHomewardPearl.REG_NAME,
	        () -> new ItemHomewardPearl(new Item.Properties().tab(CREATIVE_TAB).stacksTo(16)));
	...
	public static final RegistryObject<Item> ITEM_GILDED_PORTAL = ItemRegistrar.ITEMS.register(BlockGildedPortal.REG_NAME,
	        () -> new BlockItem(BlockRegistrar.BLOCK_GILDED_PORTAL.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
	public static final RegistryObject<Item> ITEM_GOLD_PORTAL = ItemRegistrar.ITEMS.register(BlockGoldPortal.REG_NAME,
	        () -> new BlockItem(BlockRegistrar.BLOCK_GOLD_PORTAL.get(), new Item.Properties()));
	public static final RegistryObject<Item> ITEM_LOCAL_TELEPORTER = ItemRegistrar.ITEMS.register(BlockLocalTeleporter.REG_NAME,
	        () -> new BlockItem(BlockRegistrar.BLOCK_LOCAL_TELEPORTER.get(), new Item.Properties()));
	public static final RegistryObject<Item> ITEM_PORTAL_KEYHOLE = ItemRegistrar.ITEMS.register(BlockPortalKeyhole.REG_NAME,
	        () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_KEYHOLE.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
	public static final RegistryObject<Item> ITEM_PORTAL_CROWN = ItemRegistrar.ITEMS.register(BlockPortalCrown.REG_NAME,
	        () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_CROWN.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
	public static final RegistryObject<Item> ITEM_CHARGER_FULL = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_FULL,
	        () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_FULL.get(), new Item.Properties().tab(ItemRegistrar.CREATIVE_TAB)));
	public static final RegistryObject<Item> ITEM_CHARGER_USED = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_USED,
	        () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_USED.get(), new Item.Properties()));
	public static final RegistryObject<Item> ITEM_CHARGER_DAMAGED = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_DAMAGED,
	        () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_DAMAGED.get(), new Item.Properties()));
