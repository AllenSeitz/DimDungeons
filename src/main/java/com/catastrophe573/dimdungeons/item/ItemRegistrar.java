...
public class ItemRegistrar
{
	...
	public static final DeferredItem<BlockItem> ITEM_GILDED_PORTAL = ItemRegistrar.ITEMS.register(BlockGildedPortal.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_GILDED_PORTAL.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockGildedPortal.REG_NAME)))));
	public static final DeferredItem<BlockItem> ITEM_GOLD_PORTAL = ItemRegistrar.ITEMS.register(BlockGoldPortal.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_GOLD_PORTAL.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockGoldPortal.REG_NAME)))));
	public static final DeferredItem<BlockItem> ITEM_LOCAL_TELEPORTER = ItemRegistrar.ITEMS.register(BlockLocalTeleporter.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_LOCAL_TELEPORTER.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockLocalTeleporter.REG_NAME)))));
	public static final DeferredItem<BlockItem> ITEM_PORTAL_KEYHOLE = ItemRegistrar.ITEMS.register(BlockPortalKeyhole.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_KEYHOLE.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockPortalKeyhole.REG_NAME)))));
	public static final DeferredItem<BlockItem> ITEM_PORTAL_CROWN = ItemRegistrar.ITEMS.register(BlockPortalCrown.REG_NAME, () -> new BlockItem(BlockRegistrar.BLOCK_PORTAL_CROWN.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockPortalCrown.REG_NAME))).rarity(Rarity.UNCOMMON)));
	public static final DeferredItem<BlockItem> ITEM_CHARGER_FULL = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_FULL, () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_FULL.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockRegistrar.REG_NAME_CHARGER_FULL)))));
	public static final DeferredItem<BlockItem> ITEM_CHARGER_USED = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_USED, () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_USED.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockRegistrar.REG_NAME_CHARGER_USED)))));
	public static final DeferredItem<BlockItem> ITEM_CHARGER_DAMAGED = ItemRegistrar.ITEMS.register(BlockRegistrar.REG_NAME_CHARGER_DAMAGED, () -> new BlockItem(BlockRegistrar.BLOCK_CHARGER_DAMAGED.get(), new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, BlockRegistrar.REG_NAME_CHARGER_DAMAGED)))));
