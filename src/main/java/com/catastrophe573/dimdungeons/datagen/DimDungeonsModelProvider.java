...
public class DimDungeonsModelProvider extends ModelProvider
{
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels)
    {
        ...
        Identifier portalItem = ModelTemplates.FLAT_ITEM.create(portalBlock, portalTextures, blockModels.modelOutput); // create an inventory item just in case
        ...
        Identifier wall3 = ModelTemplates.WALL_INVENTORY.create(crownBlock, crownTextures, blockModels.modelOutput);
        ...
        Identifier damagedModel = Identifier.fromNamespaceAndPath("dimdungeons", "block/block_key_charger_damaged");
        ...
        Identifier usedModel = Identifier.fromNamespaceAndPath("dimdungeons", "block/block_key_charger_used");
        ...
        Identifier fullModel = Identifier.fromNamespaceAndPath("dimdungeons", "block/block_key_charger");
...
//        keyholeTextures_default.put(TextureSlot.PARTICLE, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
//        keyholeTextures_default.put(TextureSlot.UP, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
//        keyholeTextures_default.put(TextureSlot.DOWN, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
//        keyholeTextures_default.put(TextureSlot.BACK, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
//        keyholeTextures_default.put(TextureSlot.FRONT, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_keyhole_front"));
//        keyholeTextures_default.put(TextureSlot.WEST, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
//        keyholeTextures_default.put(TextureSlot.EAST, Identifier.fromNamespaceAndPath("dimdungeons", "block/block_gilded_portal"));
...
//        Identifier keyholeItem = ModelTemplates.CUBE.create(keyholeBlock, keyholeTextures_default, blockModels.modelOutput); // create inventory item for keyhole
//        blockModels.registerSimpleItemModel(keyholeBlock, keyholeItem);
    ...
    {
        ItemModel.Unbaked itemmodel$unbaked = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "item/generated")), Optional.of(""), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked1 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_01", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_blank_theme_key")), Optional.of("_01"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked2 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_02", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_blank_theme_key")), Optional.of("_02"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked3 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_03", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_blank_theme_key")), Optional.of("_03"), TextureSlot.LAYER0)));
    ...
    {
        ItemModel.Unbaked itemmodel$unbaked = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath("minecraft", "item/generated")), Optional.of(""), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked1 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_001", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_001"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked2 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_002", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_002"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked3 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_101", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_101"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked4 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_102", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_102"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked5 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_103", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_103"), TextureSlot.LAYER0)));
        ItemModel.Unbaked itemmodel$unbaked6 = ItemModelUtils.plainModel(itemModels.createFlatItemModel(item, "_999", new ModelTemplate(Optional.of(Identifier.fromNamespaceAndPath(DimDungeons.MOD_ID, "item/item_portal_key")), Optional.of("_999"), TextureSlot.LAYER0)));
        itemModels.itemModelOutput
                .accept(
                        item,
                        ItemModelUtils.conditional(
